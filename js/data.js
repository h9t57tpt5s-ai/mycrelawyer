...
const RELAW_DATA = {
  ...
  cases: [
    ...
    },
    {
      id: "live-054",
      addedDate: "2026-08-31",
      title: "The Retail Property Trust v. Nassau County Dept. of Assessment (Roosevelt Field $4.8M Reporting-Fine Appeal)",
      category: "zoning-land-use",
      status: "ruling",
      date: "2026-08-06",
      ...
      source: "live",
      sourceUrl: "https://storage.courtlistener.com/pdf/2026/08/06/the_retail_property_trust_v._nassau_cnty._dept_of_assessment.pdf",
      summary: "The Second Circuit affirmed a $4.8 million fine Nassau County imposed on The Retail Property Trust, the Simon Property Group-affiliated owner of Roosevelt Field Mall, for failing to file two consecutive years of mandatory financial disclosures under the County's Annual Statement of Income and Expense (ASIE) Law. The panel held the value-linked penalty was not grossly disproportional under the Eighth Amendment's Excessive Fines Clause given the property's value and the owner's willful, repeated noncompliance, affirming summary judgment for the County out of the Eastern District of New York.",
      significance: "Confirms that municipalities can tie escalating disclosure penalties directly to a commercial property's assessed value and have those penalties survive constitutional scrutiny, even at multimillion-dollar levels, so long as noncompliance is willful and repeated. A separate opinion questioning whether corporations can invoke the Excessive Fines Clause at all signals an unresolved issue that could shape how commercial owners contest other value-linked regulatory fines going forward.",
      body: [
        "A commercial property owner's bid to strike down one of the steepest municipal reporting penalties in the country has failed, but not without a notable wrinkle. On August 6, 2026, the U.S. Court of Appeals for the Second Circuit affirmed a $4.8 million fine levied against The Retail Property Trust, the entity that holds title to Roosevelt Field, one of the largest shopping malls in the United States, for failing to file mandatory financial disclosures with Nassau County's Department of Assessment. The decision is a clean win for local tax authorities, but a separate opinion from one judge on the panel raises a constitutional question that could echo well beyond Long Island.",
        "At issue is Nassau County's Annual Statement of Income and Expense Law, known as the ASIE Law, which requires owners of income-producing commercial property to report detailed financial data, including rent rolls and operating expenses, to the county assessor each year. The purpose is straightforward: assessors cannot accurately value large commercial properties, and therefore cannot tax them fairly, without visibility into the income those properties actually generate. Owners who decline to comply do not face a flat penalty; the ASIE Law calculates fines as a percentage of the property's market value, an approach designed to make noncompliance costly in direct proportion to what is at stake.",
        "The Retail Property Trust, an entity within the ownership structure controlled by Simon Property Group, did not file the required statements for two consecutive years, and Nassau County assessed a cumulative fine of $4.8 million. Rather than pay and report, the Trust sued, arguing the ASIE Law's penalty scheme violates the Eighth Amendment's Excessive Fines Clause, the Fourteenth Amendment's Due Process Clause, and several New York state-law provisions. The case had been working its way through the U.S. District Court for the Eastern District of New York for years before the district court granted summary judgment in the county's favor, teeing up the appeal.",
        "The Second Circuit's core holding tracks a familiar proportionality analysis. Excessive Fines Clause claims turn on whether a penalty is grossly disproportional to the gravity of the underlying offense, a standard that looks at both the harm caused and the defendant's culpability. The panel reasoned that a $4.8 million fine, while large in absolute terms, amounts to a small fraction of one percent of the assessed value of a multi-hundred-million-dollar regional mall. Weighed against two straight years of willful noncompliance with a valid, generally applicable reporting law, rather than a one-time lapse or a good-faith interpretive dispute, the court found nothing grossly disproportional about the county's response, and the due process and state-law claims fared no better.",
        "The more consequential thread runs through a separate opinion by one member of the panel, who agreed the fine should stand but declined to join the majority's apparent assumption that the Excessive Fines Clause protects corporate entities in the first place. Whether a constitutional guarantee rooted in protecting individuals from punitive government overreach extends with equal force to corporate landowners has never been squarely resolved by the Supreme Court in this context, and the concurrence's skepticism signals the issue remains live even where, as here, it did not change the outcome.",
        "For commercial owners, the immediate lesson is procedural rather than constitutional: disclosure mandates like the ASIE Law are not paperwork to treat as optional, because the penalty structure is built to scale with exactly the kind of high-value assets that draw the least sympathy from reviewing courts, and owners in Nassau County and the growing number of jurisdictions with comparable income-and-expense reporting regimes should treat annual filing deadlines as fixed compliance obligations tied directly to dollar exposure rather than discretionary submissions weighed against the cost of preparing the underlying data. At the same time, the panel's internal disagreement over corporate standing under the Excessive Fines Clause is worth watching closely, since if that reasoning gains traction it could reshape how commercial owners contest not just ASIE-style penalties but a broader universe of value-linked regulatory fines, including code-violation penalties and rent-registration fines, that municipalities increasingly use as revenue and compliance tools against large corporate property owners; portfolio owners with holdings across multiple jurisdictions would be well served to audit their local reporting-compliance calendars now, given how readily other tax authorities appear to be adopting Nassau County's model."
      ],
      timeline: [
    ...
    },
    {
      ...
      title: "In re Palmer Center Foreclosure — Wells Fargo Tower & FirstBank Building (Colorado Springs Public Trustee Foreclosure)",
      category: "lending-foreclosure",
      status: "filed",
      date: "2026-08-25",
      ...
      source: "live",
      sourceUrl: "https://gazette.com/2026/08/25/colorado-springs-tallest-most-prominent-buildings-fall-into-foreclosure/",
      summary: "El Paso County Public Trustee's Office records show foreclosure notices filed against RPalmer LLC, Overland Palmer LLC, and Palmer Center Owner LLC — Delaware entities controlled by California-based real estate investment and management companies — over a loan with an unpaid principal balance of roughly $59 million against an original $74 million facility. The filings cover downtown Colorado Springs' two tallest buildings, the Wells Fargo Tower and FirstBank Building at the Palmer Center complex, plus several ancillary business-suite properties reachable through either tower.",
      significance: "A marquee, long-tenured downtown office complex defaulting on debt service — rather than a commodity suburban asset — signals that post-pandemic office distress has moved beyond the most obviously troubled properties. Owners, lenders, and asset managers with loans maturing in secondary downtown markets should treat trophy status and blue-chip anchor tenancies as no longer sufficient on their own to guarantee refinancing in the current rate environment.",
      body: [
        ...
        "The Palmer Center default is not an outlier so much as a data point in a broader downtown Colorado Springs office story. Second-quarter 2026 figures put downtown vacancy at 10.4 percent, with roughly 589,500 square feet of available space, against a citywide office vacancy rate near 12 percent and about 4.2 million square feet available market-wide. Trophy towers with long operating histories and blue-chip anchor tenants, and the Wells Fargo and FirstBank names both reflect long-term banking tenancies rather than mere branding, have generally weathered the post-pandemic office downturn better than commodity suburban product. That a marquee downtown asset like Palmer Center is nonetheless now in default on debt service suggests the erosion in debt service coverage tied to elevated interest rates, softer renewal demand, and compressed net operating income has moved beyond the most obviously troubled assets and into buildings that anchor a city's skyline and downtown identity.",
        "A loan does not need to be underwater on a mark-to-market valuation basis to default. An inability to refinance or pay down principal at maturity, or a shortfall in ongoing debt service coverage, can trigger a default well before an appraisal reflects meaningful value impairment, particularly for loans originated in a lower-rate environment now facing refinancing at materially higher costs. The public trustee process itself is worth understanding on its own terms: in non-judicial foreclosure states, borrowers often have materially less time and fewer procedural levers to contest a filing than they would in a judicial foreclosure jurisdiction, making early engagement with the lender or special servicer, well before a notice of election and demand is recorded, considerably more valuable than after the clock starts running.",
        "Ownership structures matter here too. Because the foreclosure reaches multiple affiliated single-purpose entities and ancillary business-suite parcels tied to the same complex, lenders and borrowers alike should expect that a default on a complex's primary loan can sweep in adjacent, separately titled parcels financed under cross-collateralized or cross-defaulted loan documents, a structure common in mixed-use downtown developments assembled parcel by parcel over time. The case is also a reminder that not every entity sharing an address or a marketing identity shares in a default: the Antlers hotel, though physically connected to the Palmer Center towers and often marketed alongside them, is separately owned and is not named in these foreclosure filings, underscoring the importance of precise title and lien diligence before drawing conclusions about a complex's overall financial health from a single component's distress.",
    ...
    },
    {
      ...
      source: "live",
      sourceUrl: "https://therealdeal.com/chicago/2026/04/19/inside-situs-big-loop-office-foreclosure-lawsuit/",
      summary: "Special servicer SitusAMC filed a foreclosure suit against the borrower entity behind 181 West Madison Street, a 50-story Chicago Loop office tower, over a $240 million loan, coupling the complaint with a motion to appoint Hilco Real Estate's Matthew Mason as receiver. The borrower is wholly owned by Bermuda-based SinOceanic I Limited, which took ownership in 2023 out of prior landlord HNA Group's bankruptcy; the default follows a downsized lease renewal by anchor tenant Northern Trust and reports of unpaid utility bills and vendors.",
      significance: "Illustrates how quickly a single anchor tenant's downsized renewal can push a stabilized-looking office asset into default, and how special servicers are now bundling receivership requests directly into foreclosure complaints to secure operational control of distressed towers well before any final judgment.",
      body: [
        ...
        "The borrower is an LLC wholly owned by SinOceanic I Limited, a Bermuda-incorporated entity that emerged as 181 West Madison's owner in 2023 out of the bankruptcy of the tower's prior landlord, Chinese conglomerate HNA Group. That bankruptcy exit was itself supposed to stabilize the asset's ownership; instead, within roughly two years the property is back in distress, this time on the loan side rather than the corporate-parent side. According to reporting on the filing, the proximate trigger was a downsized lease renewal by Northern Trust, a major tenant whose reduced footprint materially weakened the cash flow supporting the debt load, and the distress has spread beyond the mortgage itself: utility bills and payments to certain vendors servicing the building have reportedly gone unpaid.",
        "The receivership request is the more consequential element of the filing for building operations in the near term. Illinois foreclosure law, like that of most states, allows a mortgagee to seek appointment of a receiver upon a showing that the collateral's value is threatened or that the borrower is not adequately maintaining or funding the property — and once a receiver is appointed, the borrower's principals typically lose day-to-day operational and financial control of the asset well before any foreclosure judgment becomes final. Naming a specific proposed receiver, as SitusAMC did with Hilco's Matthew Mason, is a common special-servicing tactic that can compress the timeline for a court to grant that relief, particularly where the servicer can point to unpaid vendors and utilities as evidence of active neglect rather than a merely hypothetical risk.",
        "The case sits within a broader wave of Loop office foreclosures that has continued through 2026, as elevated rates, softer downtown leasing fundamentals, and loans originated at higher pre-pandemic valuations converge on maturity or default. What distinguishes 181 West Madison is less the dollar figure than the layered ownership history: a foreign corporate parent's own bankruptcy already forced one change of control at the property level in 2023, and the tower is now facing a second, this time driven by a single major tenant's downsizing rather than any broader corporate restructuring. The sequence underscores that emerging from a sponsor-level bankruptcy does not by itself de-risk an asset if the underlying lease roll and market fundamentals have not also improved.",
        "For owners, lenders, and asset managers watching the Chicago office market, or any downtown office market carrying legacy pre-2022 debt, the filing offers a few durable lessons. A single anchor tenant's lease downsizing can flip a stabilized-looking asset into default territory faster than headline occupancy figures suggest, so lenders and borrowers alike should stress-test debt coverage against a major tenant's renewal risk well before a lease expiration rather than after it is signed. Special servicers are increasingly bundling a receivership request into the foreclosure complaint itself rather than pursuing it as a later, separate motion, meaning a distressed borrower should assume operational control of the asset is at risk from the moment a foreclosure suit is filed, not merely once a judgment is entered. Unpaid vendor and utility bills are being treated by servicers as documentary support for receivership, so cash-management decisions made during a workout negotiation carry real litigation consequences. And an ownership change stemming from a sponsor's bankruptcy resolves corporate-level risk but does nothing to cure asset-level cash-flow problems, so acquirers of distressed CRE debt or equity coming out of a bankruptcy process should underwrite the in-place rent roll independently of whatever stability the restructuring itself appeared to deliver."
      ],
      timeline: [
    ...
    },
    {
      ...
      title: "Rialto Capital Advisors v. Jenel Management Corp. ($17.7M Loop Retail Condo Foreclosure)",
      category: "lending-foreclosure",
      status: "filed",
      date: "2026-04-01",
      jurisdiction: "Circuit Court of Cook County, Illinois",
      ...
      source: "live",
      sourceUrl: "https://therealdeal.com/chicago/2026/04/01/rialto-files-loop-retail-foreclosure-lawsuit-against-jenel/",
      summary: "Rialto Capital Advisors, as special servicer for a securitized commercial mortgage loan trust, filed suit on April 1, 2026 in the Circuit Court of Cook County to foreclose on a roughly 20,211-square-foot retail condominium occupying the first two floors of a 21-story tower at 36 South State Street. The complaint alleges landlord Jenel Management Corp. and affiliated entities defaulted on the loan's scheduled maturity, with Rialto now claiming approximately $17.7 million including default interest and liquidation fees; a Cook County hearing is set for September 28, 2026.",
      significance: "A maturity-default foreclosure on ground-floor retail, an asset type once viewed as more resilient than office, signals that the Loop's distressed-debt cycle now extends beyond office towers. CRE lenders, special servicers, and downtown retail owners should treat a strong operating history as no guarantee against maturity-wall refinancing failure in the current rate environment.",
      body: [
        "A CMBS special servicer has filed suit to foreclose on a two-floor retail condominium at the base of a 21-story tower on Chicago's State Street, the latest sign that loan maturity defaults continue to work through the Loop's distressed commercial debt even in property types that once looked more resilient than office. Rialto Capital Advisors, acting as special servicer for a securitized commercial mortgage loan trust, filed the foreclosure action on April 1, 2026 in the Circuit Court of Cook County, Illinois, against Jenel Management Corp. and affiliated Jenel Real Estate entities, the New York-based landlord that owns the roughly 20,211-square-foot retail condominium occupying the first two floors of the tower at 36 South State Street, at the corner of State and Monroe.",
        "The dispute traces back to a 2018 transaction in which Jenel purchased the retail condominium from Thor Equities, the New York investment firm led by Joe Sitt, for approximately $26 million, assuming roughly $16.8 million of existing mortgage debt in the process. According to Rialto's complaint, that loan reached its scheduled maturity date and went unpaid, triggering the default now at issue. Rialto's filing puts the total amount owed at approximately $17.7 million, reflecting not just the original principal balance but also default interest, late fees, and liquidation costs that accrue once a CMBS loan transfers to special servicing and enforcement begins. Cook County's circuit court has scheduled a hearing in the matter for September 28, 2026, an early test of how quickly the foreclosure can proceed and whether Jenel intends to contest the default or negotiate a resolution before judgment.",
        "The case is procedurally a straightforward commercial mortgage foreclosure, but its context matters more than its mechanics. Retail condominiums at high-profile downtown corners were, for much of the past decade, treated as a relatively defensive CRE asset class: unlike office towers grappling with a structural shift toward remote and hybrid work, ground-floor retail in a dense urban core depends primarily on foot traffic and tenancy rather than corporate space decisions. The State Street corridor has nonetheless weathered its own version of the broader Loop's struggles, and financing underwritten against pre-pandemic rent and occupancy assumptions is increasingly colliding with maturities in a materially higher interest-rate environment, pushing otherwise performing properties into technical default simply because the maturity balloon cannot be refinanced on comparable terms.",
        "For landlords and lenders alike, the dispute is a reminder that special servicers move deliberately once a maturity default occurs. CMBS pooling and servicing agreements generally require the servicer to act in the collective interest of certificate holders, which in practice means pursuing foreclosure, receivership, or a negotiated workout on a timeline dictated by the trust's governing documents rather than by any particular borrower's preferences. A borrower facing an approaching maturity wall has meaningfully more leverage before a default occurs and a loan transfers to special servicing than after a servicer has already filed suit, at which point the practical range of outcomes narrows toward a pressured forbearance, a receivership that displaces the borrower from day-to-day control, or a foreclosure sale that extinguishes the borrower's equity entirely.",
        "Owners and lenders active in downtown Chicago should treat this filing as a data point rather than an isolated incident: a loan secured by a well-located, seemingly stable retail asset can still default on maturity without any precipitating tenant bankruptcy or occupancy collapse, simply because 2018-vintage debt-service coverage and loan-to-value assumptions no longer clear today's underwriting bar. Commercial borrowers with loans approaching maturity, particularly those originated at pre-2022 rate and valuation assumptions, should engage lenders on extension or refinancing terms well before the maturity date rather than waiting for a monetary default to force the conversation, and buyers evaluating distressed or maturing CRE debt in the Loop should model maturity risk independently of a property's clean operating history, since strong performance to date is no longer sufficient assurance that a loan will refinance on its own terms."
      ],
      timeline: [
        { when: "2018", label: "Jenel acquires the retail condominium from Thor Equities, assuming ~$16.8M of existing debt" },
        { when: "April 1, 2026", label: "Rialto Capital Advisors files a $17.7M foreclosure suit in Cook County Circuit Court", current: true },
        { when: "September 28, 2026", label: "Cook County hearing scheduled in the foreclosure action", upcoming: true }
      ],
      tags: ["cmbs foreclosure", "special servicer", "retail condo", "loan maturity default", "chicago"]
    },
    {
      id: "live-077",
      addedDate: "2026-09-05",
      title: "Redimere Advisors LLC v. Plymouth Industrial REIT, Inc. (Unregistered Broker's $60M Merger Injunction Denied)",
      category: "reit-securities",
      status: "ruling",
      date: "2026-01-20",
      jurisdiction: "Suffolk County Superior Court, Massachusetts",
      ...
      source: "live",
      sourceUrl: "https://www.masschapter93ainsights.com/2026/06/massachusetts-business-litigation-session-holds-unregistered-broker-cannot-recover-20-million-success-fee-for-take-private-transaction/",
      summary: "In the Business Litigation Session of Suffolk County Superior Court, Justice Kenneth W. Salinger denied Redimere Advisors LLC's emergency motion to enjoin, or alternatively escrow $60 million in proceeds from, Plymouth Industrial REIT's $2.1 billion all-cash take-private acquisition by Makarora Management LP and Ares Alternative Credit funds. The court dismissed all of Redimere's claims to a roughly $20 million oral success fee, holding the fee was both outside the scope of Redimere's written engagement letter and unenforceable because Redimere acted as an unregistered broker on a securities transaction.",
      significance: "Confirms that unregistered intermediaries cannot use oral fee arrangements to claim a cut of a REIT M&A transaction, and shows courts' reluctance to freeze merger proceeds or delay a closing on a contested, legally weak fee claim. Relevant to REITs and advisory firms alike in structuring and enforcing deal-introduction and success-fee agreements.",
      body: [
        ...
        "Plymouth Industrial REIT, a publicly traded industrial REIT, agreed to be acquired by an investor group led by Makarora Management LP together with funds affiliated with Ares Alternative Credit in an all-cash transaction valuing the company at $22.00 per share, or approximately $2.1 billion. Redimere Advisors, which describes itself as a real estate advisory and brokerage firm, claimed it had orally agreed with Plymouth to earn a 2% success fee, roughly $20 million on a deal of this size, in exchange for introducing Plymouth to the Makarora and Ares buyer group and assisting in bringing the take-private transaction to a close. Plymouth countered that its only written engagement with Redimere, a letter agreement dated November 28, 2022, covered a narrower scope of equity-financing work and did not extend to the merger. When Plymouth declined to pay the claimed fee, Redimere sued and sought an emergency injunction that would have blocked the merger from closing, or alternatively diverted roughly $60 million of the merger proceeds into escrow with a third-party trustee pending resolution of its claims.",
        "Justice Salinger's ruling disposed of the case on two independent grounds, either of which would likely have been sufficient on its own. First, the court found that the written 2022 engagement letter did not cover the take-private transaction with Makarora and Ares, meaning Plymouth had no contractual obligation to pay Redimere a fee on that deal regardless of what role Redimere may have played in facilitating it. Second, and more consequentially for the broader industry, the court held that any oral agreement to pay Redimere a transaction-based success fee was unenforceable because Redimere was acting as an unregistered broker in connection with a securities transaction, in violation of the registration requirements of the federal Securities Exchange Act. Because the merger involved the sale of Plymouth's publicly traded securities rather than a direct asset sale, arranging or facilitating that transaction for a transaction-based fee is activity federal securities law reserves to registered broker-dealers, and an unregistered firm generally cannot use the courts to enforce a fee arrangement premised on having performed that function.",
        "The decision carries implications well beyond this single dispute. Real estate advisory firms, deal originators, and finders frequently operate on the understanding that a handshake or email exchange promising a percentage-based fee for introducing a buyer is enforceable so long as the introduction leads to a closed transaction. Where the underlying transaction is structured as a stock or securities deal, as REIT take-privates and public company mergers generally are, that assumption can be wrong as a matter of law regardless of the equities of who actually brought the parties together, since the registration requirement exists precisely to ensure that intermediaries facilitating securities transactions are subject to regulatory oversight.",
        "For REITs and other public companies pursuing M&A or take-private transactions, the case also illustrates how courts weigh eleventh-hour injunction requests aimed at merger proceeds. Judges are generally reluctant to freeze deal proceeds or delay a closing based on a contested fee claim where the underlying contractual and regulatory defenses are strong enough to be resolved at the motion stage. Redimere's decision to seek both an injunction against the closing and, alternatively, an escrow of tens of millions of dollars reflects a litigation strategy that depends on a court being willing to disrupt a transaction's timeline even where the underlying claim is legally shaky, and here that strategy failed on both fronts.",
        "REITs and other public real estate companies negotiating with outside advisors, brokers, or deal originators should ensure written engagement letters clearly define the scope of covered transactions, since ambiguity about whether a later, larger deal falls within an earlier engagement is exactly the kind of gap that generates litigation. Any intermediary expecting to earn a transaction-based fee on a securities deal should confirm it is either a registered broker-dealer or that its role and compensation fit within an available exemption before assuming an oral fee arrangement will be enforceable, and companies facing a late fee dispute as a deal approaches closing should recognize that courts are generally unwilling to freeze merger proceeds absent a strong showing on the merits, which limits the practical leverage such claims carry even on an emergency basis."
      ],
      timeline: [
        { when: "November 28, 2022", label: "Plymouth and Redimere sign a written engagement letter covering equity-financing work" },
        { when: "January 20, 2026", label: "Justice Salinger denies Redimere's injunction and dismisses all claims, clearing the $2.1B merger to close", current: true }
      ],
    ...
    },
    {
      id: "live-081",
      addedDate: "2026-09-06",
      title: "Vesta Capital, LLC v. Kulick (Investor Fraud Suit Over $1B Multistate Apartment Portfolio Collapse)",
      category: "reit-securities",
      status: "pending",
      date: "2026-04-01",
      ...
      source: "live",
      sourceUrl: "https://oklahomawatch.org/2026/04/08/a-rats-nest-of-fraud-and-deceit-new-lawsuit-adds-to-vesta-realty-ceos-legal-troubles/",
    ...
    },
    {
      ...
      source: "live",
      sourceUrl: "https://www.aol.com/investor-suing-embattled-johnston-developer-110458110.html",
      summary: "Des Moines physician and private lender Dr. Bernard Feldman sued jailed Johnston, Iowa developer Daniel Pettit, real estate CEO Rob Orton, and their jointly held entity Mozart Properties on April 22 in Polk County, alleging breach of contract over an unpaid $850,000 loan made in 2021. The suit is the first in the sprawling Pettit fraud fallout to name Orton, chief executive of American Group LLC, a roughly twenty-company real estate holding group.",
      significance: "The case illustrates how private, relationship-based lending to local developers can leave lenders exposed once a borrower's distress spreads across dozens of affiliated entities, and how creditors increasingly pursue co-obligors and business partners once a primary borrower's own assets are exhausted or already subject to competing judgments. Private CRE lenders and investors should treat joint-and-several liability provisions and diligence on a borrower's other outstanding obligations as essential loan-structuring safeguards.",
      body: [
    ...
    },
    {
      ...
      source: "live",
      sourceUrl: "https://www.mpamag.com/us/news/general/court-dismisses-us-bank-foreclosure-claim-against-company-over-default-delay/587753",
      summary: "The Appellate Division, Second Department modified a Supreme Court, Queens County order and held that U.S. Bank National Association abandoned its foreclosure claim against defaulted defendant Black Plaza Management, LLC by waiting until December 2019, well over a year after Black Plaza's default in a 2017-filed action, to move for a default judgment. A four-judge panel found the bank's delay violated CPLR 3215(c)'s mandatory one-year window and rejected its explanations as insufficient, dismissing the claim against Black Plaza and awarding it costs.",
      significance: "The ruling is a reminder that CPLR 3215(c)'s one-year deadline applies with equal, mandatory force to commercial mortgage defendants as it does in the high-volume residential foreclosure context where the rule is more commonly litigated. CMBS trustees, portfolio lenders, and special servicers managing large foreclosure dockets should treat the deadline as a hard compliance trigger on every defaulted defendant, not just an administrative afterthought, since an otherwise valid and undisputed mortgage claim was dismissed here solely for missing it.",
      body: [
        "A commercial mortgage foreclosure action that began in 2017 ended this summer not with a judgment of foreclosure and sale, but with a dismissal that turned entirely on the calendar rather than the merits. The Appellate Division, Second Department modified a Supreme Court, Queens County order and held that U.S. Bank National Association had abandoned its foreclosure claim against defendant Black Plaza Management, LLC by waiting far too long to move for a default judgment after Black Plaza failed to answer the complaint. The ruling is procedural rather than substantive, but for commercial mortgage lenders, loan servicers, and the counsel who manage foreclosure dockets on their behalf, it is exactly the kind of decision that deserves attention.",
        "U.S. Bank commenced the underlying action in March 2017, seeking to foreclose a mortgage encumbering real property in Jackson Heights, Queens. Black Plaza Management, one of several named defendants, never answered the complaint or otherwise appeared in the litigation, except later to contest the motion practice at issue in this appeal. Under CPLR 3215(c), once a defendant defaults, a plaintiff has exactly one year from that default to take proceedings toward entry of judgment; if the plaintiff fails to do so and cannot show sufficient cause for the delay, the court is required to dismiss the claim as abandoned. The statute's language is mandatory, and New York's appellate courts have consistently applied it that way, even against institutional plaintiffs pursuing large secured claims.",
        "That is precisely what tripped up U.S. Bank here. The bank did not move for a default judgment against Black Plaza until December 2019, well over two years after Black Plaza's default and roughly a year and a half beyond CPLR 3215(c)'s one-year window. The four-judge panel sided with Black Plaza, finding that the bank had failed to demonstrate it took any timely proceedings toward judgment within the statutory year and that its proffered explanations for the delay did not amount to sufficient cause. The panel modified the lower court's order to dismiss the foreclosure claim against Black Plaza as abandoned and awarded costs to the company.",
        "The decision is unremarkable doctrinally, since CPLR 3215(c) has generated a substantial and fairly consistent body of Second Department case law over the years, much of it arising in the residential foreclosure context where large mortgage servicers manage enormous dockets and inevitably let some files languish. What makes the ruling worth flagging for a commercial and institutional audience is the reminder that the same mandatory, no-exceptions rule applies with equal force outside the residential space. A defaulted commercial mortgagor, an LLC holding a single investment property, benefits from exactly the same one-year fuse as a homeowner facing foreclosure on a primary residence, and servicers who treat commercial files as lower priority than high-volume residential dockets are working against a statute that draws no such distinction.",
        "Courts applying CPLR 3215(c) have recognized only a narrow set of excuses as sufficient cause for missing the one-year deadline: law office failure alone is generally insufficient, and generic assertions about docket volume or servicing transfers tend to fare no better, while plaintiffs who can point to genuine, documented obstacles, such as an intervening bankruptcy stay or active settlement negotiations reflected in the record, have occasionally survived dismissal. The default rule assumes abandonment once the clock runs out, and the burden sits with the plaintiff to rebut that presumption with specifics rather than generalities.",
        "For CMBS trustees, portfolio lenders, and the special servicers and law firms who manage foreclosure pipelines on their behalf, the practical upshot is straightforward: foreclosure counsel should calendar the CPLR 3215(c) deadline the moment a defendant's default is established and build in an internal alert well before the one-year mark to confirm a qualifying motion has actually been filed, lenders should periodically audit stalled or inactive foreclosure files across their servicing portfolios, especially matters that predate a servicing transfer or change of outside counsel, where institutional memory of a filing deadline is exactly what tends to get lost, and where a delay is genuinely unavoidable, counsel should contemporaneously document the reason in the file, because a court applying CPLR 3215(c) will ask for specifics years later, and a thin record is what turned a fully securitized mortgage claim into a dismissed one here."
      ],
      tags: ["foreclosure", "CPLR 3215", "new york", "loan servicing", "procedural dismissal"]
    },
    {
      id: "live-086",
      addedDate: "2026-09-08",
      title: "Hoffmann v. WBI Energy Transmission, Inc. (SCOTUS Cert Grant on Pipeline Eminent Domain Attorney-Fee Preemption)",
      category: "eminent-domain",
      status: "appeal",
      date: "2026-06-29",
      ...
      source: "live",
      sourceUrl: "https://www.scotusblog.com/cases/hoffmann-v-wbi-energy-transmission-inc/",
      summary: "The U.S. Supreme Court granted certiorari on June 29, 2026 in Hoffmann v. WBI Energy Transmission, Inc., No. 25-159, agreeing to decide whether the Natural Gas Act displaces state fee-shifting statutes that would otherwise let a landowner recover attorney's fees after a pipeline company condemns property using federal eminent domain authority. The case arises from WBI Energy's 2018 taking of pipeline easements across McKenzie County, North Dakota land, after which the Eighth Circuit reversed a roughly $380,000 fee award the landowners had won under North Dakota's fee-shifting statute.",
      significance: "The ruling will define the true cost of contesting a federal eminent domain valuation for any property owner along a proposed pipeline, transmission line, or other federally licensed infrastructure corridor, and a broad preemption holding could invite condemnors in other federally licensed contexts to argue state fee-shifting and cost-recovery statutes no longer reach them either. Developers and landholders with property banked along known utility corridors should watch the decision closely and factor the current fee uncertainty into any condemnation negotiating posture now.",
      body: [
        "The U.S. Supreme Court agreed on June 29, 2026 to resolve a question that has quietly divided lower courts for years and that matters well beyond the pipeline industry: when a private company exercises the federal government's eminent domain power to condemn land, who pays the landowner's attorney's fees. In Hoffmann v. WBI Energy Transmission, Inc., the Court will decide whether Section 7 of the Natural Gas Act displaces state fee-shifting statutes, like North Dakota's, that would otherwise let a successful condemnee recover the legal costs of fighting over just compensation. For any property owner, developer, or institutional landholder whose real estate sits along a proposed pipeline, transmission line, or other federally licensed infrastructure corridor, the outcome will help define the true cost of resisting a taking.",
        "The case traces back to 2018, when WBI Energy Transmission, Inc. exercised federal eminent domain authority under Natural Gas Act Section 7(h) to acquire pipeline easements across property owned by McKenzie County, North Dakota landowners Leonard and Denae Hoffmann, along with Randall Stevenson and Rocky Prestangen. The Natural Gas Act allows FERC-certificated pipeline companies to condemn private property for interstate gas transportation projects, but Section 7(h) itself does not directly address who bears the cost of litigating the condemnation, leaving that gap to be filled by state law under the federal condemnation procedure rules that ordinarily apply. North Dakota is among the states whose statutes entitle a landowner who successfully contests an eminent domain valuation to recover reasonable attorney's fees from the condemnor.",
        "The Hoffmanns and their co-petitioners reached a confidential settlement with WBI over the underlying just-compensation figure in 2021, but the parties kept litigating over the landowners' legal fees. A federal district court sided with the landowners, ordering WBI to pay roughly $380,000 in attorney's fees and related costs under North Dakota's fee-shifting statute. WBI appealed, and the Eighth Circuit reversed in the pipeline company's favor, holding that federal law displaces North Dakota's fee statute once a condemnation proceeds under the Natural Gas Act's federal eminent domain authority, leaving the landowners on the hook for their own legal expenses despite having successfully pressed their compensation claim and setting up the circuit-level conflict the Supreme Court has now agreed to resolve.",
        "The question presented turns on a distinctly technical but consequential point of federal preemption doctrine: whether Congress, in authorizing FERC-certificated pipelines to invoke federal eminent domain power under Section 7, meant to displace the state-law rules that would otherwise govern ancillary aspects of a condemnation proceeding, including fee-shifting, or whether those state-law rules continue to apply by default because Section 7 itself is silent on the subject. The landowners argue that federal condemnation procedure has long incorporated state law on exactly these kinds of questions absent a clear congressional directive to the contrary, while WBI contends that a uniform federal rule is necessary to avoid a patchwork of fee obligations that would vary pipeline-by-pipeline depending on which state's easement happens to be at issue.",
        "The case is expected to be argued during the Court's October 2026 Term, with a date to be set once briefing is complete. Because the question presented is framed narrowly around the Natural Gas Act, a ruling will speak directly to landowners facing pipeline condemnations, but the reasoning could reverberate further, since federal eminent domain authority is not unique to natural gas pipelines and also underlies certain transmission-line and other federally licensed infrastructure condemnations, where a broad preemption holding could invite condemnors to argue that state fee-shifting statutes no longer apply to them either.",
        "For commercial and agricultural landowners, developers with land banked along known utility corridors, and the counsel who represent them in condemnation proceedings, the case is worth tracking closely regardless of which side ultimately prevails. A ruling for WBI Energy would mean federally licensed pipeline condemnors need not reimburse a landowner's legal fees even when the landowner successfully increases the compensation award, meaningfully raising the practical cost of contesting a lowball valuation and likely pushing more owners to settle quickly rather than litigate, while a ruling for the Hoffmanns would preserve state fee-shifting protections in this context and, in states with landowner-friendly statutes, keep real pressure on condemnors to make credible initial offers. Either way, property owners anywhere along a proposed interstate pipeline route should factor the current fee-shifting uncertainty into their negotiating posture now and document litigation costs carefully if a dispute proceeds, since the decision will likely settle how this fee question is litigated nationwide for years to come."
      ],
      tags: ["eminent domain", "Natural Gas Act", "preemption", "north dakota", "pipeline"]
    },
    {
      id: "live-087",
      addedDate: "2026-09-08",
      title: "Wilmington Trust National Association v. Nakash Lincoln LLC (Hotel Lincoln CMBS Foreclosure)",
      category: "lending-foreclosure",
      status: "filed",
      date: "2026-08-14",
      jurisdiction: "Circuit Court of Cook County, Illinois",
      ...
      source: "live",
      sourceUrl: "https://therealdeal.com/chicago/2026/08/18/nakash-family-faces-25m-foreclosure-lawsuit-on-hotel-lincoln/",
      summary: "Wilmington Trust National Association, acting as CMBS trustee, sued Nakash Lincoln LLC and Lincoln 1816 LLC on August 14 in the Circuit Court of Cook County, seeking to foreclose on the $25.4 million mortgage secured by Hotel Lincoln, a 184-room boutique property overlooking Lincoln Park Zoo at 1816 North Clark Street. The loan matured on March 6, 2026 without repayment and was transferred to special servicing weeks later; the Nakash family, founders of Jordache Enterprises, bought the hotel for $73 million in 2016 from an entity tied to Neil Bluhm's Walton Street Capital.",
      significance: "The filing is the third Nakash-family commercial property to face lender foreclosure action in 2026, alongside a Wells Fargo suit over 40,000 square feet of Midtown Manhattan retail and a default on a Miami Beach hotel loan, illustrating how a single sponsor's capital strain can surface as parallel, uncoordinated foreclosure filings across unrelated assets and jurisdictions. CMBS special servicers and hospitality lenders should treat a maturity default as a potential signal of a borrower's broader distress rather than an isolated credit event.",
      body: [
        "Wilmington Trust National Association, acting as trustee for the commercial mortgage-backed securities trust holding the loan, filed a $25.4 million foreclosure lawsuit on August 14, 2026 in the Circuit Court of Cook County against Nakash Lincoln LLC and Lincoln 1816 LLC, entities controlled by the Nakash family, founders of the Jordache jeans empire. The target of the suit is Hotel Lincoln, a 184-room boutique property overlooking Lincoln Park Zoo at 1816 North Clark Street in Chicago. The loan matured on March 6, 2026 without repayment and was transferred to special servicing shortly afterward, and the foreclosure complaint is the concrete legal step that followed once workout discussions failed to produce a resolution.",
        "The property carries a well-documented history. The Nakash family acquired Hotel Lincoln for $73 million in 2016 from an entity controlled by billionaire developer Neil Bluhm's Walton Street Capital, positioning it as a boutique asset in one of Chicago's most recognizable tourist corridors near the lakefront and zoo. A decade later, the $25.4 million loan securing the property became the subject of a foreclosure complaint that, like most CMBS foreclosure actions, does not allege mismanagement of the asset itself so much as a straightforward failure to satisfy the loan at maturity. Wilmington Trust's complaint seeks the customary remedies in a securitized commercial mortgage default: a judgment of foreclosure, appointment of a receiver to manage the property pending sale, and recovery of outstanding principal, accrued interest, and the trust's costs and fees.",
        "What elevates the filing beyond an isolated maturity default is its place in a broader pattern across the Nakash family's commercial holdings. In New York, Wells Fargo has filed a separate foreclosure complaint in New York State Supreme Court targeting roughly 40,000 square feet of retail space at 633 Third Avenue in Midtown Manhattan, owned by Joe Nakash, over a troubled $32 million loan. In South Florida, the family has defaulted on a $28 million loan tied to the Ocean Drive Breakwater Hotel in Miami Beach. Taken together, the three matters describe a family real estate platform facing simultaneous maturity-default litigation in three separate jurisdictions and across hospitality and retail assets within the same year.",
        "That pattern is what CMBS special servicers, bondholders, and workout counsel are watching closely across the broader lending market: sponsors who built diversified regional portfolios during the low-rate years of the last decade are now facing coordinated refinancing gaps as loans mature in a materially higher-rate environment, and a single sponsor's distress can surface as multiple, geographically unconnected foreclosure filings rather than one consolidated proceeding, since each loan sits in its own securitization silo with its own trustee and local counsel and no structural mechanism forces a unified resolution.",
        "For lenders and servicers evaluating a maturity default, the case underscores the value of treating a single missed payment as a potential window into a borrower's broader capital position rather than an isolated event, and of cross-referencing a sponsor's other holdings before agreeing to forbearance or modification terms that assume the distress is confined to one asset. It is also a reminder to owners of well-located, historically strong-performing hospitality and retail assets that an irreplaceable location does not insulate a loan from the current maturity wall, and that refinancing conversations are best started well before a maturity date rather than after a default has already been declared."
      ],
      tags: ["foreclosure", "CMBS", "hospitality", "illinois", "loan maturity default"]
    },
    {
      id: "live-088",
      addedDate: "2026-09-08",
      ...
      summary: "Alder at Lake Park LLC, an entity tied to Daniel Goldstein of Bofsa Properties, sued the Town of Lake Park, Florida in federal court in late August, alleging the town's attorney, Tom Baird, tried to coerce a sale of Alder's seven-parcel affordable housing assemblage by threatening that 'all problems would go away' if it sold to a developer he had lined up, then directed a code enforcement officer to issue 34 violations after Alder refused. The suit seeks to enjoin further code fines, compel the town to act on pending development applications for The Kelsey at Park Avenue, and recover damages; Baird has denied the allegations and called the suit retaliatory.",
      significance: "The case pairs a familiar developer grievance, hostile municipal code enforcement, with a far less common legal theory naming a sitting town attorney personally in an extortion and corruption scheme tied to a rival buyer. Developers assembling sites for affordable or mixed-income housing in small municipalities should treat it as a reminder of how concentrated a single official's discretion over permitting and code enforcement can become, and of the value of contemporaneously documenting every interaction that touches on alternative buyers or settlement overtures.",
      body: [
        "A New York-based developer has taken an unusually aggressive legal stance against a municipality's land-use apparatus, filing a federal complaint in late August 2026 in the U.S. District Court for the Southern District of Florida accusing the Town of Lake Park, Florida of corruption, blackmail, and extortion in connection with a stalled affordable housing project. The plaintiff, Alder at Lake Park LLC, an entity tied to Daniel Goldstein of New York-based Bofsa Properties, alleges that the town's own attorney, Tom Baird, tried to coerce it into selling its assembled development site to a developer of his choosing, and that when Alder refused, the town retaliated with a wave of code enforcement citations designed to grind the project to a halt.",
        "The underlying project, known as The Kelsey at Park Avenue, is a mixed-use affordable housing development planned for a seven-parcel assemblage Alder controls at the intersection of Park Avenue and 10th Street in Lake Park, a small Palm Beach County municipality just north of West Palm Beach. According to the complaint, Baird met with Goldstein and Alder's representatives and stated that he personally opposed the project and would never let Alder build what it wants. The complaint further alleges Baird told Alder's representatives that all problems would go away if the company instead sold the assembled parcels to a developer he had already identified. When Alder declined, the complaint alleges, Baird directed a town code enforcement officer to issue 34 separate code violations against the properties, a volume Alder characterizes as retaliatory rather than the product of independently identified code deficiencies.",
        "The lawsuit seeks an injunction barring the town from imposing further code enforcement fines, an order compelling Lake Park to act on Alder's pending development applications rather than leave them in administrative limbo, and monetary damages for the harm the delay and citations have allegedly caused the project's economics. Baird has denied the allegations attributed to him and has characterized the lawsuit as retaliation against him and other town officials for performing their official duties.",
    ...
    },
    {
      ...
      title: "Kane Creek Development Watch v. Lieutenant Governor of Utah (Echo Canyon Preliminary Municipality Challenge)",
      category: "zoning-land-use",
      status: "pending",
      date: "2026-02-10",
      ...
      source: "live",
      sourceUrl: "https://www.sltrib.com/news/2026/02/14/utah-law-shifts-power-elected/",
      summary: "Kane Creek Development Watch and Living Rivers sued the Utah Lieutenant Governor and the developer behind Echo Canyon on February 10 in Utah's Seventh District Court, seeking to void the state's 2024 'preliminary municipality' law and the certification it conferred on Echo Canyon, a proposed 176-acre resort development near Moab. The suit alleges SB258 unconstitutionally hands zoning and land-use authority to a developer-controlled governing board without an election or public vote.",
      significance: "Utah's preliminary municipality statute is among the most aggressive state-law vehicles yet for letting a developer exercise quasi-governmental zoning authority over its own project, and a ruling on its constitutionality will inform how other states calibrate similar developer-self-governance proposals. Developers and lenders relying on first-of-their-kind statutory entitlement structures should treat certification as provisional, not settled, until the litigation resolves.",
      body: [
        "A pair of Utah nonprofits, Kane Creek Development Watch and Living Rivers, filed suit on February 10, 2026 in Utah's Seventh District Court in Grand County against the Lieutenant Governor of Utah, who administers the certification process at issue, and against the developer behind Echo Canyon, a proposed 176-acre mixed-use resort development in the Kane Creek canyon corridor southwest of Moab along the Colorado River. The complaint asks the court to invalidate both Senate Bill 258, the 2024 statute that created Utah's 'preliminary municipality' designation, and the certification the law conferred on Echo Canyon as the state's first project to use it.",
        "SB258 lets landowners who control a qualifying parcel petition the Lieutenant Governor's office to certify a transitional governing board with authority to adopt zoning ordinances, approve infrastructure, and otherwise exercise land-use powers ordinarily reserved to elected county or city government, while the entity pursues a path toward formal incorporation as a town. Echo Canyon received that certification in June 2025, becoming the first project in the state to do so. Current plans for the site call for roughly 478 housing units, 102 overnight accommodations, and about 67,000 square feet of commercial space in a corridor that had otherwise been governed by Grand County's land-use code.",
        "The plaintiffs' central claim is constitutional: that SB258 transfers zoning and land-use authority to a board effectively selected by and answerable to the landowners seeking to develop the property, without an election, public vote, or the oversight mechanisms that ordinarily constrain a municipality's exercise of police power. The complaint separately argues the statute is an impermissible 'private or special' law under the Utah Constitution's bar on legislation that benefits a specific, identifiable private party rather than establishing a generally applicable rule, contending SB258's qualifying criteria fit only the Echo Canyon parcel at the time of passage.",
        "The governance challenge does not stand alone. The same two plaintiffs filed a related suit in mid-2025 challenging the water rights Echo Canyon's developer has claimed for the project, arguing several of the underlying rights, including one the plaintiffs say lapsed in 2019 after the developer missed a state filing deadline, have been forfeited through decades of nonuse and cannot lawfully support the scale of development now proposed. A hearing on motions to dismiss in that companion case was calendared for March 2026. Together, the two matters put both Echo Canyon's governing authority and its water supply before Utah courts at the same time.",
        "The case carries weight beyond Grand County. A small but growing number of states have experimented with statutory pathways letting large-scale developers exercise quasi-governmental land-use authority over their own projects, marketed as a way to accelerate housing and infrastructure delivery without waiting on traditional municipal approval processes. Utah's preliminary municipality law is among the most aggressive versions of that model now on the books, and a ruling on its constitutionality will shape how other states calibrate similar proposals and how far developers elsewhere can lean on self-governance structures to bypass friction with existing local government.",
        "The practical upshot for CRE developers and their counsel is that a governance structure built on novel, largely untested statutory authority should be treated as a live litigation risk rather than a closed entitlement question, with underwriting timelines built accordingly rather than assuming certification is the final word. Because the fight over Echo Canyon's governing authority is running alongside a separate water-rights forfeiture claim, sponsors of large resort or mixed-use projects in water-constrained jurisdictions should independently confirm that every underlying water right has been affirmatively put to beneficial use and well documented, since a forfeiture theory can sink a project's viability regardless of how the zoning dispute comes out. And because a successful constitutional challenge here could retroactively cloud title, permits, or entitlements issued while the certification was in effect, lenders and equity partners financing projects that rely on first-of-their-kind statutory structures should watch this litigation closely rather than treat the underlying law as settled."
      ],
      tags: ["zoning", "land use", "utah", "municipal incorporation", "constitutional challenge"]
    },
    {
      id: "live-090",
      addedDate: "2026-09-09",
      title: "Four Mile Capital LLC v. Reynolds South Tower LLC (River's Edge at Manchester Construction-Defect Fraud Suit)",
      category: "construction-defect",
      status: "pending",
      date: "2026-08-07",
      ...
      amount: "$40M+",
      source: "live",
      sourceUrl: "https://richmondbizsense.com/2026/08/17/water-leaks-at-manchester-apartments-lead-to-40m-lawsuit-between-developer-current-owner/",
      summary: "Four Mile Capital, which bought the 212-unit River's Edge at Manchester apartment building in Richmond for nearly $50M in 2021, sued developer Reynolds South Tower LLC and principals Guy Blundon and Mark Purcell in Richmond Circuit Court in May 2025, alleging fraud, breach of contract, negligence, and business conspiracy over water leaks a 2023 investigation attributed to a building envelope not built to its design, including missing waterproof sheathing Four Mile says it was told had been installed. At an August 7 hearing, the defense moved to dismiss the fraud counts, arguing Four Mile was not misled; Chief Judge Jacqueline S. McClenney said she expects to rule within a few weeks.",
      significance: "Tests how far a seller's negotiated post-closing repair commitment for a known defect can survive scrutiny once an independent investigation reveals the underlying construction problem was materially different, and larger, than represented at the time of sale. Buyers who accept a repair arrangement in lieu of a price reduction for a known issue should treat the case as a guide to preserving a later fraud claim if the seller's account of the defect's cause proves false.",
      body: [
        "A $40 million dispute between the developer of a Richmond riverfront apartment tower and the investment firm that bought it is now before the Richmond Circuit Court, testing how far a seller's post-closing repair promises can shield it from a fraud claim once the underlying defects turn out to run deeper than disclosed. Four Mile Capital, the Denver-based investment firm that paid nearly $50 million in 2021 for River's Edge at Manchester, a 212-unit riverfront apartment building at 505 Porter Street in Richmond, Virginia, is asking the court to let a fraud claim against the building's developer proceed to trial. The developer, Reynolds South Tower LLC, an entity associated with Guy Blundon of CMB Development and Mark Purcell of Purcell Construction Corp., is fighting to have that fraud count dismissed, arguing at an August 7 hearing that Four Mile was never misled about the condition of the building it bought.",
        "The dispute traces back to the 2021 sale itself. Four Mile has acknowledged it knew River's Edge had experienced water leaks before the sale closed, and that the sellers agreed, as part of the deal, to perform repairs both before and after closing. For roughly a year, that arrangement held, with repair work continuing into 2022. But Four Mile alleges that by 2022, Purcell had stopped making good on the repair commitment, and the leaks persisted. In 2023, after the water intrusion continued despite the earlier repairs, Four Mile hired an outside engineering firm to investigate the building envelope. That investigation, the complaint alleges, revealed that River's Edge was not built in accordance with its own architectural design, and specifically that the building lacked the waterproof sheathing Four Mile says it was told had been installed. First filed in Richmond Circuit Court in May 2025, the suit asserts fraud, breach of contract, negligence, and business conspiracy, and seeks more than $40 million in damages.",
        "The legal fight now centers on a distinction that separates ordinary construction-defect claims from fraud claims: whether a seller's affirmative misrepresentation about how a building was actually constructed, as opposed to a general failure to disclose a known defect, survives a motion to dismiss under Virginia law. Reynolds South Tower's attorney, Stephen Faraci of Whiteford, Taylor & Preston, argued that Four Mile was not misled about the state of the building, framing the pre-sale water leaks and subsequent repair arrangement as evidence that Four Mile bought the property with eyes open to its condition. Four Mile's attorney, Dylan Graham of the Fairfax-based Wise Law Firm, countered that the misrepresentations extended beyond the leaks Four Mile already knew about, to specific, verifiable claims about the building's underlying construction that a 2023 investigation showed were false.",
        "If Judge McClenney allows the fraud count to survive, the case will proceed toward discovery on the theory that a seller's repair commitments during and after a sale process do not necessarily cure, or waive, an underlying misrepresentation about how the asset was built in the first place, a sequence increasingly common in multifamily transactions where sellers negotiate a known-issue, ongoing-repair framework to keep a deal moving rather than disclosing the full scope of a defect before closing. A dismissal, by contrast, would reinforce the more buyer-protective baseline: that a purchaser who proceeds to close with actual knowledge of a defect assumes substantial risk that later-discovered aggravating facts will not resurrect a fraud theory once the deal is done.",
        "For buyers of existing multifamily assets, the case is a reminder to document precisely what representations a seller makes about the underlying cause and construction of a known defect whenever a repair commitment is negotiated in lieu of a price reduction or holdback, since a promise to fix the problem does not necessarily waive a later fraud claim if the seller's account of the defect's cause turns out to be false. Commissioning an independent forensic investigation promptly once negotiated repairs stall or fail to resolve a recurring issue can be decisive both for quantifying damages and for establishing that a construction-method misrepresentation, rather than merely a disclosed defect, is what is actually being litigated, and sellers extending post-closing repair support for a known issue should recognize that continuing that support, rather than disclosing its full scope up front, will not necessarily insulate them from fraud exposure if the underlying defect proves more extensive than represented at the time of sale."
      ],
      tags: ["construction defect", "fraud", "virginia", "multifamily", "richmond"],
      judge: "Jacqueline S. McClenney"
    },
    {
      id: "live-091",
      addedDate: "2026-09-09",
      title: "Mack Real Estate Group v. X Denver Ownership (X Denver Apartments Receivership Suit)",
      category: "lending-foreclosure",
      status: "filed",
      date: "2026-09-04",
      jurisdiction: "Denver District Court, Colorado",
    ...
    },
    {
      ...
      title: "Grand at Doral I Condominium Association, Inc. v. Prime Properties at Doral, LLC et al. (Developer-Affiliate Association Control Suit)",
      category: "landlord-tenant",
      status: "filed",
      date: "2026-08-25",
      jurisdiction: "Miami-Dade County Circuit Court",
      ...
      source: "live",
      sourceUrl: "https://therealdeal.com/miami/2026/09/10/doral-condo-owners-sue-over-developers-association-control/",
      summary: "The owners' association for the 80-unit Grand at Doral I condominium sued entities affiliated with the building's original developer, the Pablo Jose Valdes Florida Irrevocable Trust, alleging the trust's affiliates, Prime Properties at Doral and Premier Properties at Doral, hold 41 of the building's 80 units and a package of developer-only rights -- including exemption from leasing restrictions and capital-contribution requirements -- years after construction completed in 2022. The declaratory judgment complaint asks the court to determine whether Prime and Premier are validly exempt from the building's leasing restrictions and how parking spaces tied to an adjacent developer-controlled lot should be assigned.",
      significance: "Illustrates a recurring Florida condo-conversion risk in which a developer conveys a majority of units to affiliated entities that retain outsized voting power and disparate rights after the statutory turnover point, and where the declaration's own amendment mechanics can make those provisions effectively unamendable without the affiliates' own consent. Developers and buyers of post-conversion condominium interests should scrutinize affiliate unit-holdings and exemption clauses, since Florida courts have shown increasing willingness to entertain owner challenges to governance structures that preserve developer control indefinitely.",
      body: [
        "Four years after Grand at Doral I welcomed its first residents, the 80-unit condominium's owners' association has gone to court to settle a question that has quietly shaped life in the building since it opened: who actually controls it. The association filed a declaratory judgment action in Miami-Dade County Circuit Court against entities affiliated with the building's original developer, the Pablo Jose Valdes Florida Irrevocable Trust, alleging that the developer never fully relinquished control of the property even though construction wrapped in 2022. According to the complaint, the trust transferred 41 of the building's 80 units -- a bare majority -- to two affiliated companies, Prime Properties at Doral and Premier Properties at Doral, both managed by Lucilla Suero and Niurka Fonte-Esquivel in their capacity as co-trustees of the Valdes trust.",
        "The dispute is not simply about vote counting. The complaint alleges that when the trust conveyed those units to Prime and Premier, it also granted the two entities a package of developer rights that ordinary owners do not have, including the ability to rent out their units freely and an exemption from the leasing restrictions and capital-contribution obligations that apply to everyone else in the building. The association is asking the court to determine whether Prime and Premier are in fact exempt from the building's unit-leasing restrictions, and how parking spaces tied to an adjacent lot controlled by the Valdes trust should be assigned among owners.",
        "What makes the case more than a routine internal governance dispute is a structural problem the association's own attorneys have flagged: under Grand at Doral I's governing documents, amending the declaration to eliminate Prime and Premier's exemptions would itself require a vote of Prime and Premier, since they control the votes needed to approve any such change. That circularity is precisely the kind of governance lock that Florida courts and legislators have grown increasingly skeptical of, as condominium associations statewide have pushed back against developers who structure post-completion ownership to preserve outsized influence long after a building is sold out.",
        "Florida law generally requires developer-controlled boards to transition to unit-owner control once a statutory threshold of units has been sold, though the mechanics vary by declaration and by how developer affiliates are defined. Litigation over these structures typically turns on close reading of the declaration's own definitions -- whether an entity that is legally distinct from the developer but commonly controlled, and that originally received units as part of the developer's own allocation, should be treated as a developer affiliate for voting and disclosure purposes, or as an ordinary owner entitled to vote its full block.",
        "For Grand at Doral I's independent owners, the practical stakes are straightforward: leasing flexibility, assessment obligations, and control over the building's finances and maintenance priorities all hinge on the outcome. For the broader Florida condominium market, already reshaped by post-Surfside structural reforms that increased financial and disclosure burdens on associations statewide, the case is a reminder that governance battles over developer influence remain very much alive even in buildings with no structural safety issues at all. Developers structuring post-completion ownership through affiliated entities should expect close judicial scrutiny of arrangements that concentrate voting power or preserve exemptions unavailable to other owners, particularly where those exemptions can only be undone with the affiliate's own consent, and unit owners or newly independent boards evaluating a developer transition would do well to audit the declaration for circular amendment requirements before assuming that a nominal transfer of control has actually shifted governing authority."
      ],
      tags: ["condominium", "developer control", "leasing restrictions", "HOA governance", "Florida"]
    },
    {
      id: "live-127",
      addedDate: "2026-09-11",
      title: "Anchorage Community Development Authority v. Hughes Family LLC and Anchorage Innovation District LLC (Downtown Nordstrom Site Partition Action)",
      category: "eminent-domain",
      status: "filed",
      date: "2026-07-21",
      ...
      body: [
        ...
        "For commercial owners and public redevelopment authorities elsewhere watching downtown revitalization efforts stall out, the case is a useful illustration of a structural risk inherent in any redevelopment site assembled through partial acquisitions over time: co-ownership arrangements that made sense as an acquisition strategy can become the primary obstacle once it's time to actually build. Public and private co-owners assembling redevelopment sites through incremental acquisitions would be well served to negotiate binding governance and exit mechanisms, such as buy-sell provisions, deadlock-breaking procedures, or agreed redevelopment timelines, at the time of acquisition rather than relying on informal cooperation once entitlement and financing decisions actually need to be made, since minority co-owners retain real exposure to a majority owner's partition remedy and municipalities structuring public-private land assemblies should expect that unresolved disputes of this kind add years of delay and legal cost to projects already competing against downtown retail vacancy."
      ],
      timeline: [
        { when: "2019", label: "Nordstrom closes its downtown Anchorage store after 44 years, leaving the building vacant" },
        { when: "2020", label: "ACDA acquires a majority interest in the former Nordstrom building and the adjacent J.C. Penney parking garage" },
    ...
    },
    {
      id: "live-131",
      addedDate: "2026-09-12",
      title: "Jovia Financial Federal Credit Union v. S Indiana Avenue LLC (South Loop Office Foreclosure & Personal Guaranty Suit)",
      category: "lending-foreclosure",
      status: "filed",
      date: "2026-09-04",
      jurisdiction: "Circuit Court of Cook County, Illinois",
      ...
      body: [
        ...
        "Owners of single-tenant office assets, particularly those leased to public agencies, would be well served to treat outstanding code violations as a live threat to the lease itself rather than a routine cost of doing business, since an accumulation of unresolved citations can hand a well-resourced government tenant contractual grounds to walk away entirely. Borrowers negotiating acquisition financing should scrutinize whether a lender is requiring an unlimited personal guaranty, weigh that risk against the leverage the loan provides, and understand that such a guaranty survives even a full loss of the underlying collateral, while lenders financing single-tenant, government-leased office properties should build ongoing property-condition monitoring into loan servicing, since a landlord's deferred maintenance can just as easily cost a lender its income stream as it can cost the borrower the building."
      ],
      timeline: [
        { when: "December 31, 2021", label: "Rivlin's venture, S Indiana Avenue LLC, acquires the South Loop building for $14M" },
        { when: "January 5, 2022", label: "Jovia lends $17.5M secured by the property, with Rivlin signing an unlimited personal guaranty" },
        { when: "December 2025", label: "The state tenant, leasing the building on behalf of DCFS, stops paying rent" },
        { when: "June 2026", label: "A three-month forbearance agreement between Jovia and Rivlin expires without a cure" },
        { when: "September 4, 2026", label: "Jovia files its $17.1M foreclosure and personal guaranty complaint in Cook County Circuit Court", current: true }
      ],
      tags: ["foreclosure", "personal guaranty", "office", "government tenant", "illinois"]
    },
    {
      id: "live-132",
      addedDate: "2026-09-12",
      title: "Portland Music Holdings LLC v. City of Portland (Targeted Zoning Buffer Takings & Due Process Suit)",
      category: "zoning-land-use",
      status: "filed",
      date: "2026-06-09",
      ...
      source: "live",
      sourceUrl: "https://www.pressherald.com/2026/06/09/group-that-sought-live-nation-music-venue-in-portland-sues-city-over-buffer/",
      summary: "Portland Music Holdings LLC sued the City of Portland, Maine in federal court on June 9, alleging that a zoning moratorium and a resulting 750-foot buffer amendment between large concert venues were adopted specifically to kill its proposed 3,300-seat music venue and protect the city's own Merrill Auditorium from competition. The complaint alleges impairment of contract, due process violations, and an uncompensated taking, and asks the court to void the zoning changes and award damages and fees.",
      significance: "Illustrates how municipalities facing an unwanted or controversial project can respond not with a permit denial but with a facially neutral zoning amendment calibrated to make one specific site unbuildable, a maneuver that draws far less judicial deference once a plaintiff can show it targeted a known, pending project. Commercial and entertainment-venue developers watching a moratorium or zoning study emerge after their project becomes public should treat it as a serious litigation signal, not routine planning process.",
      body: [
      ...
      timeline: [
        { when: "Summer 2025", label: "Portland City Council enacts a temporary moratorium on large music venues" },
        { when: "February 2026", label: "City Council extends the moratorium while developing permanent zoning changes" },
    ...
    },
    {
      id: "live-135",
      addedDate: "2026-09-13",
      title: "Soros Fund Management v. Eretz Group (224 West 57th Street Foreclosure & Tenant-Takeover)",
      category: "lending-foreclosure",
      status: "ruling",
      date: "2026-09-01",
      ...
      body: [
        "George Soros's family office has completed one of the more unusual foreclosure outcomes in recent Manhattan commercial real estate history: after acquiring a defaulted mortgage on its own landlord's building, Soros Fund Management took title to 224 West 57th Street at a September 1, 2026 foreclosure auction. The ten-story, roughly 107,000-square-foot Midtown office building, a former auto showroom on the block known as Billionaires Row, is occupied primarily by Open Society Foundations, the philanthropic organization founded and funded by George Soros, leaving the building's own anchor tenant as its new owner.",
        "The dispute traces back to 2018, when Eretz Group, the New York-based developer that has owned 224 West 57th Street since 2015, borrowed $145 million from lender Aareal Capital Corp. to refinance the property. The loan carried a maturity date of June 2023, and Eretz obtained two subsequent extensions before ultimately failing to repay the principal. Rather than continue carrying the increasingly troubled loan, Aareal sold the debt to Soros Fund Management, which stepped into the lender's position and filed a foreclosure action against Eretz in the Supreme Court of the State of New York, New York County, in April 2024.",
        "What makes the case distinctive is the identity of the plaintiff-lender. Open Society Foundations occupies the majority of the office space at 224 West 57th Street as Eretz's tenant, so when Soros Fund Management purchased the distressed mortgage, it positioned an entity tied to the building's own occupant to potentially become its landlord. That dynamic played out in full at the September 1 auction, held in Lower Manhattan, where the property returned to the lender's side of the ledger rather than selling to an outside third party, the outcome typical when a foreclosing lender's credit bid exceeds what the market will pay in a still-challenging office-financing environment. The Soros-linked sale was reported alongside another Midtown foreclosure auction the same day, involving the former headquarters of the Chetrit Group, reflecting a broader wave of legacy office loans reaching their breaking point across the borough this cycle.",
        "The foreclosure judgment ultimately entered against Eretz totaled $158.7 million, reflecting the original $145 million principal plus more than two years of accrued interest, fees, and other carrying costs that piled up while the case wound through litigation. For owners and lenders navigating New York's still-recovering office market, the case is a reminder that maturity defaults on loans originated in more favorable rate environments continue to surface even years after the initial stress began, particularly where extensions merely delayed rather than resolved an underlying valuation gap. It is also a reminder that the sale of distressed debt to a new, better-capitalized noteholder is increasingly common, and that a change in lender does not necessarily signal flexibility toward the borrower.",
        "Commercial property owners carrying loans originated in the pre-2022 rate environment should proactively assess whether extensions granted so far have addressed the underlying valuation and cash-flow gap or merely deferred it, since repeated maturity extensions without a structural fix frequently end in foreclosure rather than resolution. Landlords should also treat a loan sale to a new noteholder, especially one affiliated with an existing tenant or other stakeholder in the property, as a signal that warrants closer attention than a sale to an unrelated distressed-debt fund, and tenants or other market participants aware of a building's financial distress should recognize that purchasing the underlying debt can be a more direct path to securing long-term occupancy or control of a strategically important asset than waiting to negotiate with a future owner."
      ],
      timeline: [
        { when: "2018", label: "Eretz Group borrows $145M from Aareal Capital Corp. to refinance 224 West 57th Street" },
        { when: "June 2023", label: "The loan reaches its original maturity date; two extensions follow" },
    ...
    },
    {
      id: "live-136",
      addedDate: "2026-09-13",
      title: "Cimerring v. Arbor Realty Trust, Inc. ($175M Georgia Bridge-Loan Foreclosure Fraud Suit)",
      category: "lending-foreclosure",
      status: "pending",
      date: "2026-03-27",
  ...
  trends: [
    ...
    {
      id: "trend-006",
      title: "Local Data Center Moratoria Quadruple to 374 in a Quarter as Developers Turn to Vested-Rights Litigation",
      category: "zoning-land-use",
      date: "2026-09-10",
      scope: "National (local and state data center siting)",
      metric: "374 active local moratoria, up from 92 in June 2026",
      source: "live",
      sourceUrl: "https://www.wilmerhale.com/en/insights/client-alerts/using-temporary-pauses-to-develop-permanent-regulation",
      summary: "Wells Fargo's data center tracker, compiled by analyst Shahriar Pourreza, counted 374 active local moratoria on data center development by the end of summer 2026, up from 92 in June — a roughly fourfold increase in one quarter — with Michigan, Ohio, North Carolina, Iowa, and Tennessee leading in count. Active moratoria now average roughly 346 days, and the average across all tracked measures rose to 311 days from 277, with some running as long as five years. A separate state-level tracker counted 26 of 50 states restricting or considering restrictions as of September 7, including 18 with active bans or moratoria. New York moved first statewide: after the Legislature passed the Responsible Data Center Development Act on June 4, 2026, Governor Hochul declined to sign it and instead issued Executive Order No. 62 on July 14, pausing discretionary environmental permitting for data centers above 50 megawatts for one year; Seattle adopted an emergency municipal siting moratorium on June 9.",
      significance: "Developers have begun challenging these pauses rather than waiting them out, and early results suggest hastily adopted moratoria are legally vulnerable — RCM Hill, LLC's $100M federal suit over Hill County, Texas's moratorium (arguing Texas counties lack zoning authority) prompted rescission within two weeks; ECO TIP West LLC is suing Chatham County, North Carolina, claiming $11M in reliance spending on a by-right permit created statutory vested rights under N.C. Gen. Stat. § 160D-107; and a California developer is challenging Imperial County's emergency interim ordinance for failing the 'current and immediate threat' showing required by Cal. Gov't Code § 65858(c). The dispute mix this pattern produces — ultra vires challenges, vested-rights and estoppel claims, procedural attacks on emergency findings, and eventually regulatory takings, contract-impairment, dormant commerce clause, and Federal Power Act preemption theories — should concern any owner, developer, or investor holding land optioned or contracted for data center use, since the practical exposure is a stalled entitlement with carrying costs and no clear off-ramp. Because most moratoria are transitional, the setback, water-use, noise, and community-benefit standards adopted during the pause matter more for long-run project economics than the pause itself.",
      tags: ["data centers", "moratorium", "vested rights", "zoning", "entitlement risk"]
    }
  ],
