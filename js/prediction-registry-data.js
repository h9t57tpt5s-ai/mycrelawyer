...
const PREDICTION_REGISTRY = [
  ...
  },
  {
    ...
    "predictedBestGuess": 600670.8,
    "whatIsNeededForEstimate": null,
    "likelyOutcome": "Webster has a strong contractual foothold (Lease \u00a7 4.2's audit-and-refund mechanism) and specific, itemized 2023-2024 audit findings, several of which (utilities, internal overhead, Market Rate Unit cross-charges, and LIHTC-unit insurance) are close to facially improper allocations across separate leased units. Dominium's answer is mostly denial-and-'document speaks for itself,' preserving all issues for discovery rather than conceding anything, and its limitations/waiver defenses have real bite against the unquantified pre-2023 claims but weaker purchase against the timely-audited 2023-2025 years. Net expected outcome is a partial recovery weighted toward the stronger utility/overhead/Market-Rate/insurance categories, with the legal fees, telephone, and capital improvement categories being genuine coin-flip-to-below-even fights, and the pre-2023 and 2025 buckets contributing little quantifiable value on this record.",
    "claims": [
      {
        "label": "Utility cost overcharges (2023-2024)",
        "probabilityRange": [
          0.55,
          0.75
        ],
      ...
      {
        "label": "Dominium's internal management/overhead costs (2023-2024)",
        "probabilityRange": [
          0.6,
          0.8
        ],
      ...
      {
        "label": "Market Rate Unit / portal / resident survey cross-charges (2023-2024)",
        "probabilityRange": [
          0.6,
          0.8
        ],
      ...
      {
        "label": "LIHTC Unit insurance costs (2023-2024)",
        "probabilityRange": [
          0.55,
          0.75
        ],
      ...
      {
        "label": "Legal fees improperly billed (2024)",
        "probabilityRange": [
          0.35,
          0.55
        ],
      ...
      {
        "label": "Telephone costs improperly billed (2024)",
        "probabilityRange": [
          0.35,
          0.55
        ],
      ...
      {
        "label": "Capital improvement costs improperly passed through (2024)",
        "probabilityRange": [
          0.4,
          0.6
        ],
      ...
      {
        "label": "2025 CAM overbilling (audit in progress)",
        "probabilityRange": [
          0.45,
          0.65
        ],
      ...
      {
        "label": "Declaratory judgment (Count IV)",
        "probabilityRange": [
          0.65,
          0.85
        ],
      ...
      {
        "label": "Waiver/estoppel and mitigation defenses",
        "probabilityRange": [
          0.2,
          0.4
        ],
  ...
  },
  {
    ...
    "predictedBestGuess": 4941671.875,
    "whatIsNeededForEstimate": null,
    "likelyOutcome": "H+H/NYCEDC hold the stronger position on the gating question of whether the November 3, 2024 Closing Date passed and the Option terminated, given the strict construction typically applied to negotiated commercial option deadlines and the court's prior dismissal of ARE's fraud-based excuses -- but ARE's Unavoidable Delay/Section 3.2 tolling argument is genuinely unresolved and keeps both the $5 million deposit claim and the implied-covenant damages counterclaim meaningfully contested rather than a sure thing. Expect this to proceed toward trial (or a dispositive motion shortly before it) with H+H/NYCEDC more likely than not to prevail on the core declarations and to retain the deposit, but with real downside risk on the implied-covenant damages theory and residual uncertainty on amount and timing.",
    "claims": [
      {
        "label": "Closing Date Passage / Option Termination Declaration",
        "probabilityRange": [
          0.55,
          0.7
        ],
      ...
      {
        "label": "$5 Million Predevelopment Security Deposit Retention",
        "probabilityRange": [
          0.5,
          0.65
        ],
      ...
      {
        "label": "Implied Covenant Damages for Refusal to Relinquish Option",
        "probabilityRange": [
          0.3,
          0.5
        ],
      ...
      {
        "label": "Parking Relief (Specific Performance / Declaratory / Alternative Damages)",
        "probabilityRange": [
          0.55,
          0.75
        ],
      ...
      {
        "label": "Dismissed Fraud and Implied-Covenant Damages Claims (ARE)",
        "probabilityRange": [
          0.95,
          1
        ],
      ...
      {
        "label": "Procedural Defenses (Laches, Statute of Limitations, Discretionary Declination)",
        "probabilityRange": [
          0.15,
          0.3
        ],
  ...
  {
    "registryId": "pa-pacifica-mechanicsburg-v-bjs-wholesale-club-2025",
    "caseId": null,
    "caseTitle": "Pacifica Mechanicsburg LLC v. BJ's Wholesale Club, Inc.",
    "court": "U.S. District Court for the Middle District of Pennsylvania",
    "docket": "1:25-cv-01663",
    "filings": [
      {
        "side": "plaintiff",
        "label": "Amended complaint (Nov. 25, 2025)",
        "url": "https://storage.courtlistener.com/recap/gov.uscourts.pamd.148188/gov.uscourts.pamd.148188.21.0.pdf"
      },
      {
        "side": "defendant",
        "label": "Answer, defenses and counterclaim to amended complaint (Dec. 9, 2025)",
        "url": "https://storage.courtlistener.com/recap/gov.uscourts.pamd.148188/gov.uscourts.pamd.148188.25.0.pdf"
      },
      {
        "side": "plaintiff",
        "label": "Answer to counterclaim (Apr. 16, 2026)",
        "url": "https://storage.courtlistener.com/recap/gov.uscourts.pamd.148188/gov.uscourts.pamd.148188.43.0.pdf"
      }
    ],
    "predictedAt": "2026-09-25",
    "model": "claude-sonnet-5",
    ...
    "predictedBestGuess": -1066771.3635,
    "whatIsNeededForEstimate": null,
    "likelyOutcome": "On the current record this reads as a genuinely two-sided commercial dispute where BJ's better-documented, Lease-anchored liquidated-damages counterclaim (subject to real but partial defenses) currently outweighs Pacifica's more speculative, causation-contested, and consequential-damages-limited affirmative claim -- producing a probability-weighted net exposure to the landlord rather than a net recovery, unless Pacifica prevails on the penalty/unenforceability theory or shows BJ's caused the critical-path delays.",
    "claims": [
      {
        "label": "BJ's Counterclaim for Minimum Rent Abatement (Liquidated Damages)",
        "probabilityRange": [
          0.45,
          0.65
        ],
      ...
      {
        "label": "Pacifica's Delay/Acceleration Damages Claim",
        "probabilityRange": [
          0.25,
          0.45
        ],
      ...
      {
        "label": "Enforceability of \u00a74.2(d) Liquidated Damages as an Unenforceable Penalty",
        "probabilityRange": [
          0.35,
          0.55
        ],
      ...
      {
        "label": "Consequential Damages Limitation (Lease \u00a730.4)",
        "probabilityRange": [
          0.4,
          0.65
        ],
      ...
      {
        "label": "Refund of Rent Paid Under Protest Plus Lease-Rate Interest",
        "probabilityRange": [
          0.45,
          0.65
        ],
      ...
      {
        "label": "Attorney's Fees Under the Lease",
        "probabilityRange": [
          0.3,
          0.7
        ],
      ...
      {
        "label": "Critical-Path Causation Dispute (Whose Delay Controls)",
        "probabilityRange": [
          0.3,
          0.5
        ],
  ...
  {
    "registryId": "nd-generations-on-1st-v-red-river-state-bank-2025",
    "caseId": null,
    "caseTitle": "Generations on 1st, LLC, Parkside Place, LLC and The Ruins, LLC v. Red River State Bank",
    "court": "U.S. Bankruptcy Court for the District of North Dakota (Adv. Proc.)",
    "docket": "Adv. No. 25-07009",
    "filings": [
      {
        "side": "plaintiff",
        "label": "First amended complaint (Nov. 12, 2025)",
        "url": "https://storage.courtlistener.com/recap/gov.uscourts.ndb.45995/gov.uscourts.ndb.45995.28.0.pdf"
      },
      {
        "side": "defendant",
        "label": "Defendant's first amended answer and counterclaim (Jan. 27, 2026)",
        "url": "https://storage.courtlistener.com/recap/gov.uscourts.ndb.45995/gov.uscourts.ndb.45995.42.0.pdf"
      },
      {
        "side": "plaintiff",
        "label": "Stipulation dismissing claims between The Ruins, LLC and the bank without prejudice (Mar. 12, 2026)",
        "url": "https://storage.courtlistener.com/recap/gov.uscourts.ndb.45995/gov.uscourts.ndb.45995.54.0.pdf"
      }
    ],
    "predictedAt": "2026-09-25",
    "model": "claude-sonnet-5",
    "analysisVersion": "v2",
    "category": "lending-foreclosure",
    "side": "Borrower / Guarantor",
    "predictedRange": [
      -44097.524999999994,
      0
    ],
    "predictedBestGuess": -26173.762499999997,
    "whatIsNeededForEstimate": null,
    "likelyOutcome": "This heads to trial with the Debtors likely to win at least partial relief on the good-faith/reasonably-equivalent-value fight over the forbearance agreement given the lopsided facial terms, but RRSB's documented altered-invoice fraud claim is the more immediately provable piece of this case and will likely offset, dollar-for-dollar via recoupment, whatever the Debtors recover -- meaning the net financial outcome on the pieces of this case that are currently quantifiable trends modestly negative for the Debtors, even though the Debtors have the stronger equitable narrative overall.",
    "claims": [
      {
        "label": "RRSB's Fraud Counterclaim (Altered Draw Invoices)",
        "probabilityRange": [
          0.55,
          0.75
        ],
      ...
      {
        "label": "Fraudulent Conveyance / Avoidance of Forbearance Agreement (11 U.S.C. \u00a7 548)",
        "probabilityRange": [
          0.4,
          0.6
        ],
      ...
      {
        "label": "Deceit/Fraud -- Insider Self-Dealing and Assignment-of-Rents Mismanagement",
        "probabilityRange": [
          0.35,
          0.55
        ],
      ...
      {
        "label": "Negligence Per Se (Regulatory/Reg O-Based Theory)",
        "probabilityRange": [
          0.15,
          0.3
        ],
      ...
      {
        "label": "Attorneys' Fees and Costs (Both Sides)",
        "probabilityRange": [
          0.3,
          0.6
        ],
