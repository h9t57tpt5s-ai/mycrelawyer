...
const CASE_VALUATION_DATA = {
  "spec": {
    ...
    "aggregation": {
      ...
      "categorySelection": "the backend classifies which of the 8 tracked litigation categories the matter falls under from the user's own description and any uploaded documents (no manual dropdown); only that category's claim types and role labels (sideA/sideB) are shown",
